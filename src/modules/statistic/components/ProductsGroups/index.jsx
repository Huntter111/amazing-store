  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.tableWrapper}>
        <h3 className={styles.groupATitle}><b>Група продуктів з найвищим показником продажів</b></h3>
        <Table dataSource={productsGroups?.groupA} columns={columns} pagination={false} />
      </div>
      <div className={styles.tableWrapper}>
        <h3 className={styles.groupBCTitle}><b>Група продуктів з високим показником продажів</b></h3>
        <Table dataSource={productsGroups?.groupB} columns={columns} pagination={false} />
      </div>
      <div className={styles.tableWrapper}>
        <h3 className={styles.groupBCTitle}><b>Група продуктів з середнім показником продажів</b></h3>
        <Table dataSource={productsGroups?.groupC} columns={columns} pagination={false} />
      </div>
      <div className={styles.tableWrapper}>
        <h3 className={styles.groupXTitle}><b>Група продуктів з низьким показником продажів</b></h3>
